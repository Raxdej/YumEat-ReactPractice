...
const TopNav = () =>{
    ...
    return(
        <div className="w-full max-w-[1520px] mx-auto flex justify-between items-center p-4">
            <div className="flex items-center">
                <div className="cursor-pointer" onClick={()=> setSideNav(!sideNav)}>
                    <AiOutlineMenu size={25} />
                </div>
                <h1 className="text-2xl sm:text-3sl lg:text-4xl px-2">
                    Yum
            ...
            <div className={
                ...
                <nav>
                    <ul className="text-2xl flex-col p-4 text-gray-900">
                        <li className="text-xl py-4 flex">
                            <BsPerson seed={25} className="mr-4 text-white bg-black rounded-full"/>
                            My Account
                        </li>
                        <li className="text-xl py-4 flex">
